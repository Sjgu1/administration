...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">@lang('messages.frecuencia') @lang('messages.por hora')</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <!-- /.col (LEFT) -->
        @if ($return_code != 'repositorio_invalido')
        <div class="col-md-12">
          <!-- LINE CHART -->
